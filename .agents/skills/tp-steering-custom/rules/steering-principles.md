...
- Detailed documentation of `.exec-plans/` metadata directories (settings, automation)
...
- Light references to `.exec-plans/specs/` and `.exec-plans/steering/` are acceptable; avoid other `.exec-plans/` directories
